...
//    }
    ...
    public int checkInReservation(Reservations reservation) throws ParseException, IOException{//MessagingException, IOException, com.sun.xml.internal.messaging.saaj.packaging.mime.MessagingException {
...
//            }
    ...
    public int checkOutReservation(Reservations reservation) throws ParseException, IOException{//MessagingException, IOException, com.sun.xml.internal.messaging.saaj.packaging.mime.MessagingException {
        String recevier = personJPARepo.findById(reservation.getGuestId()).getEmail();
...
//            }
    ...
    public int cancelReservationByGuest(Reservations reservation) throws ParseException, IOException{//MessagingException, IOException, com.sun.xml.internal.messaging.saaj.packaging.mime.MessagingException {
...
//            y1.sendEmail(subject1,recevier1,body1);
    ...
    public int cancelReservationByHost(Reservations reservation) throws ParseException, IOException{//MessagingException, IOException, com.sun.xml.internal.messaging.saaj.packaging.mime.MessagingException {
        OffsetDateTime cancellation_date = timeservice.getCurrentTime();
        System.out.println("offset utc date cancellation " + cancellation_date);
        LocalDate current_date = cancellation_date.toLocalDate();
        LocalDate startDate = reservation.getStartDate().toLocalDate();
