...
public class ScheduledJob {
    ...
    // check for below scheduled job
//    @Async
//    @Scheduled(fixedRate = 10000)
 //   @Transactional(propagation = Propagation.REQUIRES_NEW)
    public void processAutomatedJobs() throws IOException{//MessagingException, IOException, com.sun.xml.internal.messaging.saaj.packaging.mime.MessagingException {
